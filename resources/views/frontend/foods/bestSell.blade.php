...
@section('title','bestSell')
@section('content')

    <h4 style="color:green">Sản Phẩm Bán Chạy</h4>
    <hr>
                    ...
                    <div class="col-6 col-lg-4">
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="card-price"><span>{{$food->price}}<small>.000đ</small></span><em
                                        class="old_price"></em></h6>
                                <div class="card-text">
                            <span>
                                <ul>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 product_content">
                                                    ...
                                                    <p>{{$food->desc}}</p>
                                                    <h3 class="cost"> Giá Bán: <span class="glyphicon glyphicon-usd" style="color:red">{{$food->price}}<small>.000đ</small></span> </h3>
